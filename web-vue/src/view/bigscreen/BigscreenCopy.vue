 ...
 * https://www.ruisitech.com/licenses/opensource.html
 -->
<template>
    <el-dialog title="大屏复制" :visible.sync="show" :close-on-click-modal="false" custom-class="nopadding">
      <template slot="title">
            <span class="el-dialog__title">大屏复制</span>
...
export default {
  ...
  methods: {
     showDailog(report){
       this.report = report;
       this.show = true;
       this.table.name = report.pageName + '-COPY';
     },
